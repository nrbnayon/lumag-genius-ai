...
export default function NotificationsClient() {
  ...
  const filteredNotifications = useMemo(() => {
    ...
    if (role === "seller_admin") {
      ...
      roleNotifications = notifications.filter((n) =>
        ...
        >
          ...
          >
            ...
            <div className="p-6 border-t border-gray-100 flex gap-3">
              <button
                onClick={closeModal}
                className="flex-1 px-6 py-3 rounded-xl border border-gray-200 text-sm font-bold text-foreground hover:bg-gray-50 transition-colors"
              >
                Close
              </button>
